...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s knowlite-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  knowlite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded knowlite transaction") + "\n" +
              "  knowlite-tx [options] -create [commands]   " + _("Create hex-encoded knowlite transaction") + "\n" +
              "\n";
