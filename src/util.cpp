...
const char * const BITCOIN_CONF_FILENAME = "knowlite.conf";
const char * const BITCOIN_PID_FILENAME = "knowlite.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Knowlite";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Knowlite";
#else
    // Unix
    return pathRet / ".knowlite";
#endif
#endif
}
