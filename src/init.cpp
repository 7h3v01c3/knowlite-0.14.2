...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/knowlite-project/knowlite>";
    const std::string URL_WEBSITE = "<https://knowlite.org>";
