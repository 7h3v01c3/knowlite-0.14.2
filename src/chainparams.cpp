...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.knowlite.loshan.co.uk", true));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("knowlitetools.com", "testnet-seed.knowlitetools.com"));
