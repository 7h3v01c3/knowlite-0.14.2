...
{
    const char* pszTimestamp = "November 2nd, 2021 Learning and sharing, sharing and learning";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1635899864, 2000356917, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x754092b31b12e36fe029cd74519c626ad91cfab49001f2c5d778a6f6cfc1ae55"));
        assert(genesis.hashMerkleRoot == uint256S("0x607e3b2521bd2e4cba77619d0a4bc7abf0deff24754f35ffa00fc219393893d5"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("207.246.73.231", "207.246.73.231", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("knowlitetools.com", "dnsseed.knowlitetools.com"));
        // vSeeds.push_back(CDNSSeedData("knowlitepool.org", "dnsseed.knowlitepool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  1500, uint256S("0x754092b31b12e36fe029cd74519c626ad91cfab49001f2c5d778a6f6cfc1ae55"))
        ...
        chainTxData = ChainTxData{
            ...
            1635899864, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1635899864, 951591, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9a89866f35941a58b4cbe6d6ba6bf5d632ace6f627b4964264139e3851a358fb"));
        assert(genesis.hashMerkleRoot == uint256S("0x607e3b2521bd2e4cba77619d0a4bc7abf0deff24754f35ffa00fc219393893d5"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("207.246.73.231", "207.246.73.231"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.knowlite.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x9a89866f35941a58b4cbe6d6ba6bf5d632ace6f627b4964264139e3851a358fb")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1635899864, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xec9d1de91e7d150a53c827225e4e845f354f0cc92515c161d47b2ef29dab6ebd"));
        assert(genesis.hashMerkleRoot == uint256S("0x607e3b2521bd2e4cba77619d0a4bc7abf0deff24754f35ffa00fc219393893d5"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xec9d1de91e7d150a53c827225e4e845f354f0cc92515c161d47b2ef29dab6ebd"))
        };
